...
class LoginListener {
	...
	@BeforeTestCase
	def openBrowserBeforeEachTestCase(TestCaseContext context) {
		// Open browser if not already open
		WebUI.openBrowser('')

		// Navigate to app URL (optional, if your login navigates, you can skip)
		//WebUI.navigateToUrl(GlobalVariable.app_url)

		// Call login keyword
		KW_Login.loginIntoApplication()
	}
